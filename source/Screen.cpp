...
void Screen::DrawTopBar(const char *name) {
    ...
    Gfx::DrawIcon(32, 75 / 2, 60, Gfx::COLOR_ICON, 0xF1AB, Gfx::ALIGN_VERTICAL);
    Gfx::Print(128, 75 / 2, 60, Gfx::COLOR_TEXT, "LingoBrew", Gfx::ALIGN_VERTICAL);
    Gfx::Print(Gfx::GetTextWidth(60, "LingoBrew") + 128 + 16, 75 / 2 + 5, 50, Gfx::COLOR_ALT_TEXT, APP_VERSION_FULL, Gfx::ALIGN_VERTICAL);
    if (name) {
