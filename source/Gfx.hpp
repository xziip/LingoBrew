...
namespace Gfx {
    ...
    constexpr SDL_Color COLOR_BACKGROUND     = {0x10, 0x10, 0x13, 0xff};
    constexpr SDL_Color COLOR_ALT_BACKGROUND = {0x22, 0x23, 0x29, 0xff};
    constexpr SDL_Color COLOR_HIGHLIGHTED    = {0x00, 0x91, 0xea, 0xff};
    constexpr SDL_Color COLOR_TEXT           = {0xf8, 0xf8, 0xf8, 0xff};
    constexpr SDL_Color COLOR_ICON           = {0x00, 0x91, 0xea, 0xff};
    ...
    constexpr SDL_Color COLOR_BARS           = {0x1b, 0x1c, 0x20, 0xff};
    constexpr SDL_Color COLOR_ERROR          = {0xff, 0x33, 0x33, 0xff};
    constexpr SDL_Color COLOR_WARNING        = {0xf0, 0xff, 0x00, 0xff};
    ...
    SDL_Color GetRainbowColor(float speed = 1.0f);
} // namespace Gfx
